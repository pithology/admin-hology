                ...
                (function () {
                    ...
                    var $ = {
                        ...
                        return t.replace(E, (function (o, r) {
                            var l = "/" !== o.charAt(1), d = o.startsWith("\x3c!--"), c = r + o.length, h = t.charAt(c);
                            if (d) {
                                var u = S(o).node;
                            ...
                            if ((!l || s.voidElement) && (n > -1 && (s.voidElement || s.node.nodeName.toUpperCase() === o.slice(2, -1).toUpperCase()) && --n > -1 && (s = a[n]), "<" !== h && h)) {
                                var g = -1 === n ? i : a[n].node.childNodes || [], b = t.indexOf("<", c);
                        ...
                        return t.prototype.init = function () {
                            ...
                            for (var a, o, r, l, d, c, h = function (t, e, s) {
                            ...
                            }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), m = [], b = 0, w = 0; b < f; w += 1, b += 1) if (!n || !0 !== u[b] && !0 !== p[b]) {
                                if (!0 === u[b]) if ("#text" === (l = t.childNodes[w]).nodeName) if ("#text" === e.childNodes[b].nodeName) {
                                    if (l.data !== e.childNodes[b].data) {
                                        for (c = w; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName;) if (c += 1, e.childNodes[b].data === t.childNodes[c].data) {
                                            d = !0;
                                            break
                                        }
                                ...
                                } else m.push((new x).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 1), f = Math.min(u.length, p.length), b -= 1; else m.push((new x).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 1), f = Math.min(u.length, p.length), b -= 1; else if (!0 === p[b]) "#text" === (l = e.childNodes[b]).nodeName ? (m.push((new x).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 0, !0), f = Math.min(u.length, p.length), w -= 1) : (m.push((new x).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 0, !0), f = Math.min(u.length, p.length), w -= 1); else if (u[b] !== p[b]) {
                    ...
                    const j = (t, e) => {
                        ...
                        t.headings ? o.headings = t.headings.map((t => B(t))) : e?.tHead ? o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                            ...
                            s[e] || (s[e] = {type: n, format: a, searchable: !0, sortable: !0, isSplitQueryWord: !0});
                            const r = s[e];
                        ...
                        if (t.data ? o.data = t.data.map((t => t.map(((t, e) => q(t, s[e]))))) : e?.tBodies?.length && (o.data = Array.from(e.tBodies[0].rows).map((t => Array.from(t.cells).map(((t, e) => {
                            const i = t.dataset.content ? q(t.dataset.content, s[e]) : ((t, e) => {
                                ...
                                switch (e.type) {
                                    ...
                                    default:
                                        s = {
                                            data: M(t, {valueDiffing: !1}).childNodes || [],
                                            text: t.innerText,
                                            order: t.innerText
                                        }
                                }
                    ...
                    const z = {
                        ...
                        if (n.firstLast && a.push(U(1, n.firstText, n)), n.nextPrev) {
                            const e = t ? 1 : s - 1;
                            a.push(U(e, n.prevText, n, {hidden: t}))
                        }
                        let o = [...Array(i).keys()].map((t => U(t + 1, String(t + 1), n, {active: t === s - 1})));
                        if (n.truncatePager && (o = ((t, e, s, i) => {
                            ...
                            const t = e ? i : s + 1;
                            a.push(U(t, n.nextText, n, {hidden: e}))
                        }
                    ...
                    exports.DataTable = class {
                        constructor(t, e = {}) {
                            ...
                            const i = {...z.diffDomOptions, ...e.diffDomOptions}, n = {...z.labels, ...e.labels},
                                a = {...z.classes, ...e.classes};
                            this.options = {
                                ...z, ...e,
                                diffDomOptions: i,
                                labels: n,
                                classes: a
                            }, this._initialInnerHTML = this.options.destroyable ? this.dom.innerHTML : "", this.options.tabIndex ? this.dom.tabIndex = this.options.tabIndex : this.options.rowNavigation && -1 === this.dom.tabIndex && (this.dom.tabIndex = 0), this._listeners = {onResize: () => this._onResize()}, this._dd = new k(this.options.diffDomOptions || {}), this.initialized = !1, this._events = {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings = !1, this.hasRows = !1, this._searchQueries = [], this.init()
                        }

                        init() {
                            if (this.initialized || this.dom.classList.contains(this.options.classes.table)) return !1;
                            this._virtualDOM = M(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = {...this._virtualDOM.attributes}, this.rows = new F(this), this.columns = new Q(this), this.data = W(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
